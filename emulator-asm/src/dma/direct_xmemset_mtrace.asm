...
#
# xmemcpy_mtrace - Optimized version with memory tracing and actual memset
#
# This function performs three main tasks:
# 1. Encodes memset metadata (offsets, counts, flags) using fast_dma_encode
# 2. Records memory trace (pre-values and src data for verification/rollback)
# 3. Performs the actual memset to dst
#
# REGISTER USAGE:
...
#   rsi = fill_byte (u64)             - Byte to fill
...
# - Original destination values (pre values of pre/post)
...
.global direct_dma_xmemset_mtrace_with_count_check
...
direct_dma_xmemset_mtrace_with_count_check:
