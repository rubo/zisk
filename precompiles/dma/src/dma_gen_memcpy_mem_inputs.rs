...
pub fn generate_dma_memcpy_mem_inputs<P: MemProcessor>(
    ...
    let without_src = op == ZiskOp::DMA_INPUTCPY || op == ZiskOp::DMA_XMEMSET;
    let with_src = !without_src;
