...
pub fn secp256k1_to_affine(
    ...
    let mut y_res = secp256k1_fp_mul(
        &y,
        &zinv_sq,
        #[cfg(feature = "hints")]
        hints,
    );
    y_res = secp256k1_fp_mul(
        &y_res,
        &zinv,
        #[cfg(feature = "hints")]
        hints,
...
pub fn secp256k1_eq_projective(
    p1: &[u64; 12],
    p2: &[u64; 12],
    #[cfg(feature = "hints")] hints: &mut Vec<u64>,
) -> bool {
    ...
    let lhs_x = secp256k1_fp_mul(
        x1,
        z2,
        #[cfg(feature = "hints")]
        hints,
    );
    let rhs_x = secp256k1_fp_mul(
        x2,
        z1,
        #[cfg(feature = "hints")]
        hints,
    ...
    let lhs_y = secp256k1_fp_mul(
        y1,
        z2,
        #[cfg(feature = "hints")]
        hints,
    );
    let rhs_y = secp256k1_fp_mul(
        y2,
        z1,
        #[cfg(feature = "hints")]
        hints,
...
fn double_point_assign(p1: &mut SyscallPoint256, #[cfg(feature = "hints")] hints: &mut Vec<u64>) {
...
pub fn secp256k1_ecdsa_verify(
    ...
    let (is_infinity, res) = secp256k1_double_scalar_mul_with_g(
        &u1,
        &u2,
        pk,
        #[cfg(feature = "hints")]
...
pub unsafe extern "C" fn secp256k1_decompress_c(
    ...
    let ((x, y), success) = secp256k1_decompress(
        x_bytes,
        y_is_odd != 0,
        #[cfg(feature = "hints")]
        hints,
